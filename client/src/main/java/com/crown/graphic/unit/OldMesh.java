...
public class OldMesh {
    ...
    public OldMesh(float[] positions) {
        texVboId = -1;
        idxVboId = -1;
    ...
    public OldMesh(float[] positions, int[] indices) {
        texVboId = -1;
    ...
    public OldMesh(float[] positions, float[] texCoords) {
        idxVboId = -1;
        vertexCount = positions.length / 3;
    ...
    public OldMesh(float[] positions, int[] indices, float[] texCoords) {
        vertexCount = indices.length;
